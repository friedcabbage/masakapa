...
function App() {
  ...
  const mapCategoryToIngredients = (category) => {
    const mapping = {
      ...
      mie: ["sohun", "mie", "bihun", "soun", "noodle", "indomie", "mie goreng", "mie rebus", "mie ayam", "mie instan", "spaghetti", "pasta", "udon", "soba", "vermicelli", "rice noodle", "egg noodle", "mie telur", "mie basah", "mie kering", "mie cap cai", "mie kuah"],
      ...
      cemilan: ["empek empek", "pempek", "empek-empek", "otak otak", "otak-otak", "jajanan", "cemilan", "snack", "keripik", "chips", "kue kering", "cookies", "biskuit", "crackers", "kacang", "nuts", "cokelat", "chocolate", "permen", "candy", "kue basah", "cake", "donat", "donut", "kue cubit", "kue cubit mini", "kue cubit isi", "kue cubit cokelat", "kue cubit keju", "kue cubit pisang", "kue cubit durian", "pisang", "risol", "cireng", "pastel", "tahu isi", "tempe mendoan", "perkedel", "martabak", "roti", "pisang goreng", "cireng", "cilok", "cimol", "risol", "pastel", "tahu isi", "tempe mendoan", "perkedel", "martabak", "roti bakar", "basreng", "keripik singkong", "keripik pedas", "seblak", "sosis bakar", "telur gulung", "lumpia", "kentang goreng", "bakwan", "comro", "misro"],
      ikan: ["ikan", "fish", "salmon", "tuna", "sardine", "mackerel", "ikan bakar", "ikan goreng", "ikan kukus", "ikan asam manis", "teri", "asin", "lele", "patin", "nila", "kembung", "tongkol", "bandeng", "salmon", "tuna", "sarden", "makarel", "mujair", "mujaer", "bawal", "kakap", "buntal", "cakalang", "tongkol", "kembung", "gurame"]
    };
