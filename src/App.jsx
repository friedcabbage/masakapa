          ...
          {categories.map((cat) => {
            ...
            return (
              <div
                ...
                className={`w-20 h-10 sm:w-40 sm:h-20 text-2xl cursor-pointer rounded-xl flex items-center justify-center text-center font-semibold capitalize border transition 
                  ${
                    isSelected
