...
function App() {
  ...
  const mapCategoryToIngredients = (category) => {
    const mapping = {
      ...
      pasta: ["mac and cheese", "fettuccine", "fettuccini", "fettucine", "fettucini", "aglio olio", "aglio e olio", "sphagetti", "sphageti", "bolognais", "bolognaise", "bolognese", "pasta", "spaghetti", "fettuccine", "makaroni", "fusilli", "lasagna", "rafioli", "penne", "macaroni", "angel hair", "tagliatelle", "rigatoni", "elbow macaroni", "linguine", "mie spaghetti", "spageti bolognese", "carbonara"],
      ...
      mie: ["kwetiaw", "kwetiau", "bakmi", "sohun", "mie", "bihun", "soun", "noodle", "indomie", "mie goreng", "mie rebus", "mie ayam", "mie instan", "udon", "soba", "vermicelli", "rice noodle", "egg noodle", "mie telur", "mie basah", "mie kering", "mie cap cai", "mie kuah"],
