...
function App() {
  ...
  const mapCategoryToIngredients = (category) => {
    const mapping = {
      ...
      pasta: ["mac and cheese", "fettuccine", "fettuccini", "fettucine", "fettucini", "aglio olio", "aglio e olio", "sphagetti", "sphageti", "bolognais", "bolognaise", "bolognese", "pasta", "spaghetti", "fettuccine", "makaroni", "fusilli", "lasagna", "rafioli", "penne", "macaroni", "pasta", "angel hair", "tagliatelle", "rigatoni", "elbow macaroni", "linguine", "mie spaghetti", "pasta saus tomat", "spageti bolognese", "carbonara", "pasta keju"],
