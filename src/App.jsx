...
function App() {
  ...
  const mapCategoryToIngredients = (category) => {
    const mapping = {
      ...
      spaghetti: ["sphagetti", "sphageti", "bolognais", "bolognaise", "bolognese", "pasta", "spaghetti", "fettuccine", "makaroni", "fusilli", "lasagna", "rafioli", "penne", "macaroni", "pasta", "angel hair", "tagliatelle", "rigatoni", "elbow macaroni", "linguine", "mie spaghetti", "pasta saus tomat", "spageti bolognese", "spageti carbonara", "pasta keju"],
