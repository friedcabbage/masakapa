...
function App() {
  ...
  const mapCategoryToIngredients = (category) => {
    const mapping = {
      ...
      cemilan: ["empek empek", "pempek", "empek-empek", "otak otak", "otak-otak", "jajanan", "cemilan", "snack", "keripik", "chips", "kue kering", "cookies", "biskuit", "crackers", "kacang", "nuts", "cokelat", "chocolate", "permen", "candy", "kue basah", "cake", "donat", "donut", "kue cubit", "kue", "pisang", "risol", "cireng", "pastel", "tahu isi", "mendoan", "perkedel", "martabak", "roti", "pisang goreng", "cireng", "cilok", "cimol", "risol", "pastel", "tahu isi", "tempe mendoan", "perkedel", "martabak", "roti bakar", "basreng", "keripik singkong", "keripik pedas", "seblak", "sosis bakar", "telur gulung", "lumpia", "kentang goreng", "bakwan", "comro", "combro", "misro"],
